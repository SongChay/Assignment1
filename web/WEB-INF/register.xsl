...
<xsl:stylesheet version="1.0"
        ...
        <form action="register.jsp" method="post">
            <table>
                <tr>
                    <td>Username:</td>
                    <td>
                        <input value="{username}" type="text" name="username" placeholder="Username" required="true" />
                    </td>
                </tr>
                <tr>
                    <td>Password:</td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="password-confirm" placeholder="Confirm Password" required="true" />
                    </td>
                </tr>
                <tr>
                    <td></td>
    ...
    <xsl:template match="success">
        ...
        <p>Click <a href="login.jsp">here</a> to go login page</p>
    </xsl:template>
